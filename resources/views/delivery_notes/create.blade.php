...
<style>
    ...
    .customer-suggestions, .product-suggestions {
    ...
    .customer-suggestions .list-group-item:hover, .product-suggestions .list-group-item:hover {
    ...
    .item-name-display { font-weight: 500; margin-bottom: 0.25rem; }
    ...
    @media (max-width: 992px) {
        ...
        .item-row { grid-template-columns: 1fr; padding: 1rem; }
        .remove-item-btn { justify-self: start; margin-top: 1rem; }
    }
</style>
                        ...
                        <div class="card form-section p-3 mb-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="purchase_number" id="purchase_number" class="form-control" placeholder="Enter purchase order number" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6" id="gst-fields-container">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="number" name="cgst" id="cgst" class="form-control gst-input" placeholder="e.g. 9" value="0" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="sgst" class="form-label">SGST (%)</label>
                                            <input type="number" name="sgst" id="sgst" class="form-control gst-input" placeholder="e.g. 9" value="0" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
    ...
    <script>
        ...
        function initializeApp() {
            ...
            function updateGSTFields() {
                const gstType = gstTypeSelect.value;
                const existingCgst = document.getElementById('cgst')?.value || '0';
                const existingSgst = document.getElementById('sgst')?.value || '0';
                const existingIgst = document.getElementById('igst')?.value || '0';
                ...
                if (gstType === 'CGST') {
                    gstFieldsContainer.innerHTML = `
                        <div class="row">
                            <div class="col-6">
                                <label for="cgst" class="form-label">CGST (%)</label>
                                <input type="number" name="cgst" id="cgst" class="form-control gst-input" placeholder="e.g. 9" value="${existingCgst}" required>
                            </div>
                            <div class="col-6">
                                <label for="sgst" class="form-label">SGST (%)</label>
                                <input type="number" name="sgst" id="sgst" class="form-control gst-input" placeholder="e.g. 9" value="${existingSgst}" required>
                            </div>
                        </div>`;
                } else if (gstType === 'IGST') {
                    gstFieldsContainer.innerHTML = `
                        <label for="igst" class="form-label">IGST (%)</label>
                        <input type="number" name="igst" id="igst" class="form-control gst-input" placeholder="e.g. 18" value="${existingIgst}" required>`;
                }
                calculateTotals();
            }
