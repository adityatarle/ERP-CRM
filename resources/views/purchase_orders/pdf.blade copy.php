...
<body>
        ...
        <table class="no-border" style="margin-top: 5px;">
            <tr>
                <td class="w-50 v-align-top">
                    <div class="w-100" style="border: 1px solid #000;">
                        <h3 style="border: none; padding-left: 5px; font-size: 14px;" class="font-bold">{{ $company['name'] }}</h3>
                        <p style="border: none; padding-left: 5px;">{{ $company['address'] }}</p>
                        <p style="border: none; padding-left: 5px;">Mob: {{ $company['contact'] }}</p>
                        <p style="border: none; padding-left: 5px;">GSTIN/UIN: {{ $company['gstin'] }}</p>
                        <p style="border: none; padding-left: 5px;">State Name: {{ $company['state'] }}</p>
                        <p style="border: none; padding-left: 5px;">E-Mail: {{ $company['email'] }}</p>
                    </div>
                </td>
                <td class="w-50 v-align-top">
                    <table class="w-100" style="border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td><span class="font-bold">Other References</span><br>US HYDRAULICS</td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <div class="no-border">
        <div class="w-100" style="border: 1px solid #000;">
            <p style="border: none; padding-left: 5px; font-size: 10px;">Supplier (Bill from)</p>
            <p style="border: none; padding-left: 5px; font-size: 14px;" class="font-bold">{{ $purchaseOrder->party->name }}</p>
            <p style="border: none; padding-left: 5px;">{{ $purchaseOrder->party->address }}</p>
            <p style="border: none; padding-left: 5px;">GSTIN/UIN: {{ $purchaseOrder->party->gst_in }}</p>
            <p style="border: none; padding-left: 5px;">State Name: Maharashtra, Code: 27</p>
        </div>
    </div>
    <!-- ================== FIXED FOOTER ================== -->
    <footer class="footer">
    ...
    <main>
        ...
        <table style="margin-top: 0px;">
            <tr>
                <td colspan="5" rowspan="4" style="border-bottom: none; border-left: none; width: 60%;">
